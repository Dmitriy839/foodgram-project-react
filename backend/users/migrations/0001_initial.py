    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Укажите Логин', max_length=32, unique=True, verbose_name='Уникальный юзернейм')),
                ('first_name', models.CharField(help_text='Укажите Имя', max_length=32, verbose_name='Имя')),
                ('last_name', models.CharField(help_text='Укажите Фамилию', max_length=32, verbose_name='Фамилия')),
